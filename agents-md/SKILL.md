...
2. Create symlink: `ln -s AGENTS.md CLAUDE.md` (Unix; on Windows use `mklink CLAUDE.md AGENTS.md` from an admin shell, or skip the symlink — both files may also simply be kept in sync manually).
