...
> Built from the S01–S22 trial run (2026-08-11): the closeout report structure validated in the workflow's end-to-end trial (S22 slot). `project-retrospective` answers "how did we get here"; this skill answers "what is the state now, and what remains".
