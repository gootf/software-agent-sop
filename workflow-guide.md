...
> Date: 2026-08-11 · Version: workflow.yaml v1.0.0 (22 nodes / 33 edges)
...
A 22-node software-engineering agent SOP graph, refined through skill screening and an end-to-end trial run (9 findings, 2 P0 gaps confirmed and closed), then solidified into an **executable graph definition**:
